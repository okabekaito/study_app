...
ActiveRecord::Schema.define(version: 20_211_116_052_221) do
  create_table 'calendars', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                            force: :cascade do |t|
    t.string 'title'
    t.text 'memo'
